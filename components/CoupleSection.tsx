    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
          {/* Putri */}
          <div
            className={`flex flex-col items-center text-center transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
            {/* Photo */}
            ...
            <h3 className="elegant-serif font-cormorant text-3xl md:text-4xl text-[#FFF5E1] mb-3">
          ...
          {/* Abdul */}
          <div
            className={`flex flex-col items-center text-center transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"} delay-100`}
          >
            {/* Photo */}
            <div className="mb-6 relative">
              <div className="w-40 h-40 md:w-48 md:h-48 rounded-full overflow-hidden border-2 border-[#C9A96E] shadow-lg">
        ...
        <div className="relative mt-16 md:mt-16 pt-12 md:pt-8">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-xl md:text-xl text-[#FFF5E1] text-center leading-relaxed font-cormorant">
              Their story began with a simple hello. From quiet conversations to
              countless cherished moments, two hearts discovered a love that was
              meant to be. With every shared smile and every passing day, their
              love grew deeper and stronger. Hand in hand, they now step forward
              to begin the beautiful journey of forever.
            </p>
          </div>
        </div>
      </div>
