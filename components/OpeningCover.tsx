...
export default function OpeningCover({ onOpen, guestName }: OpeningCoverProps) {
  ...
  return (
    <section className="relative w-full h-screen flex flex-col items-center justify-center bg-black overflow-hidden text-white">
      ...
      {/* Content */}
      <div className={`relative z-10 flex flex-col items-center justify-center px-6 text-center transition-all duration-1000 ${isAnimating ? 'opacity-100' : 'opacity-0'}`}>
        {/* Decorative ornament */}
        <div className="mb-8 md:mb-12 scale-in">
          <svg className="w-12 h-12 md:w-16 md:h-16 text-white/100" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="0.5">
        ...
        <div className="mb-8 md:mb-12">
          <p className="elegant-sans text-xs md:text-sm tracking-widest text-white/60 mb-4 md:mb-6 uppercase">
        ...
        <div className="mb-12 md:mb-16">
          <p className="elegant-sans text-xs md:text-sm tracking-widest text-white/50 uppercase">
            Dear {guestName}
          </p>
        </div>
