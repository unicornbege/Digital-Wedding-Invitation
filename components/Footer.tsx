...
export default function Footer() {
  ...
  return (
    <footer
      id="footer-section"
      className="w-full bg-foreground text-background px-6 md:px-8 py-16 md:py-10"
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="elegant-serif font-cormorant text-base md:text-xl text-background/80 mb-8 md:mb-8 font-light">
          ...
          <div className="flex items-center justify-center gap-4 my-6 md:my-6">
            ...
            <svg
              className="w-4 h-4 md:w-5 md:h-5 text-background/50"
              viewBox="0 0 24 24"
              fill="currentColor"
            >
          ...
          {/* Secondary text */}
          <p className="elegant-sans font-cormorant text-base md:text-lg text-background/80 mb-8 md:mb-8 max-w-2xl mx-auto leading-relaxed">
            Your presence is the most precious gift we could ask for. Join us as
