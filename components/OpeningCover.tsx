...
export default function OpeningCover({ onOpen, guestName }: OpeningCoverProps) {
  ...
  return (
    <section
      className="relative w-full h-screen flex flex-col items-center justify-center  overflow-hidden text-white bg-no-repeat bg-cover"
    ...
    >
      ...
      {/* Content */}
      <div
        className={`relative flex flex-col items-center justify-center px-6 text-center transition-all duration-1000 ${isAnimating ? "opacity-100" : "opacity-0"}`}
      >
        {/* Decorative ornament */}
        <div className="mb-8 md:mb-12 scale-in">
          <svg
            className="w-12 h-12 md:w-16 md:h-16 text-white/100"
            viewBox="0 0 100 100"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.5"
          >
            ...
            <path
              d="M 50 15 Q 70 35, 70 50 Q 70 65, 50 85 Q 30 65, 30 50 Q 30 35, 50 15"
              strokeLinecap="round"
        ...
        <div className="mb-8 md:mb-12">
          ...
          <h1 className="elegant-serif text-5xl md:text-6xl lg:text-7xl text-white mb-4 md:mb-6 leading-tight ">
            The Wedding
          </h1>
          <p
          ...
          <h2 className="elegant-serif text-3xl md:text-4xl text-white mt-4 mb-8">
            Putri & Budi
          </h2>
        </div>
